...
//        system("reboot");
    ...
    ui->label_update->setStyleSheet("border-radius: 10px 10px 10px 10px;background-color: rgb(151, 235, 238);font-size: 24px;color: white");
}
...
void version_number::settext()
{
    ...
    ui->label_version->setStyleSheet("font-size: 24px;color: white");
