    ...
    ui(new Ui::time_setting)
{
    ...
    ui->label_save->setStyleSheet("border-radius: 10px 10px 10px 10px;background-color: rgb(151, 235, 238);font-size: 24px;color: white");
    ui->label_return->setStyleSheet("border-radius: 10px 10px 10px 10px;background-color: rgb(151, 235, 238);font-size: 24px;color: white");
}
...
{
    ui->label_year1->setStyleSheet("background-color: rgb(58, 167, 242);font-size: 24px;color: white");
    ui->label_year2->setStyleSheet("background-color: rgb(58, 167, 242);font-size: 24px;color: white");
    ui->label_year3->setStyleSheet("background-color: rgb(58, 167, 242);font-size: 24px;color: white");
    ui->label_year4->setStyleSheet("background-color: rgb(58, 167, 242);font-size: 24px;color: white");
    ui->label_month->setStyleSheet("background-color: rgb(58, 167, 242);font-size: 24px;color: white");
    ui->label_day->setStyleSheet("background-color: rgb(58, 167, 242);font-size: 24px;color: white");
    ui->label_hour->setStyleSheet("background-color: rgb(58, 167, 242);font-size: 24px;color: white");
    ui->label_minute->setStyleSheet("background-color: rgb(58, 167, 242);font-size: 24px;color: white");
    switch (time_flag) {
    case 1:
    {
        ui->label_year1->setStyleSheet("background-color: rgb(8, 93, 147);font-size: 24px;color: white");
        break;
    }
    case 2:
    {
        ui->label_year2->setStyleSheet("background-color: rgb(8, 93, 147);font-size: 24px;color: white");
        break;
    }
    case 3:
    {
        ui->label_year3->setStyleSheet("background-color: rgb(8, 93, 147);font-size: 24px;color: white");
        break;
    }
    case 4:
    {
        ui->label_year4->setStyleSheet("background-color: rgb(8, 93, 147);font-size: 24px;color: white");
        break;
    }
    case 5:
    {
        ui->label_month->setStyleSheet("background-color: rgb(8, 93, 147);font-size: 24px;color: white");
        break;
    }
    case 6:
    {
        ui->label_day->setStyleSheet("background-color: rgb(8, 93, 147);font-size: 24px;color: white");
        break;
    }
    case 7:
    {
        ui->label_hour->setStyleSheet("background-color: rgb(8, 93, 147);font-size: 24px;color: white");
        break;
    }
    case 8:
    {
        ui->label_minute->setStyleSheet("background-color: rgb(8, 93, 147);font-size: 24px;color: white");
        break;
    }
    }
}
...
void time_setting::settext()
{
    ...
    ui->label_num->setStyleSheet("font-size: 24px;color: white");
