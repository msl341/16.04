    ...
    ui(new Ui::formatting)
{
    ...
    ui->label_backdrop->setStyleSheet("border-radius: 30px 30px 30px 30px;background-color: rgb(110, 215, 230);color: white");
    ui->label_no->setStyleSheet("border-radius: 10px 10px 10px 10px;background-color: rgb(151, 235, 238);font-size: 24px;color: white");
    ui->label_yes->setStyleSheet("border-radius: 10px 10px 10px 10px;background-color: rgb(151, 235, 238);font-size: 20px;color: white");
