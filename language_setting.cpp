...
void language_setting::settext()
{
    ...
    ui->label_espanol->setStyleSheet("font-size: 24px;color: white");
    ui->label_chinese->setText(tr("简体中文"));
    ui->label_chinese->setStyleSheet("font-size: 24px;color: white");
    ui->label_english->setText(tr("English"));
    ui->label_english->setStyleSheet("font-size: 24px;color: white");
    ui->label_Tchinese->setText(tr("繁體中文"));
    ui->label_Tchinese->setStyleSheet("font-size: 24px;color: white");
    ui->label_return->setText(tr("退出"));
    //ui->label_return->setStyleSheet("color: white");
    ui->label_save->setText(tr("保存"));
    //ui->label_save->setStyleSheet("color: white");
