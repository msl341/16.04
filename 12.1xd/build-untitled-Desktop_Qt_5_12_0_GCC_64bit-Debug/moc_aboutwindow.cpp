...
#include "../untitled/aboutwindow.h"
...
QT_MOC_LITERAL(4, 54, 21) // "On_Btn_Cancel_Clicked"
    ...
    "aboutwindow\0sigReturnTowidget\0\0"
...
void aboutwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (aboutwindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&aboutwindow::sigReturnTowidget)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void aboutwindow::sigReturnTowidget()
{
