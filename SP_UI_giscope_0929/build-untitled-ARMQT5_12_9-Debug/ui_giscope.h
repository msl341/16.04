...
public:
    ...
    void setupUi(QWidget *GiScope)
    {
        ...
        label_saved = new QLabel(GiScope);
        label_saved->setObjectName(QString::fromUtf8("label_saved"));
        label_saved->setGeometry(QRect(340, 16, 181, 31));
    ...
    void retranslateUi(QWidget *GiScope)
    {
        ...
        label_saved->setText(QApplication::translate("GiScope", "<html><head/><body><p><span style=\" font-weight:600;\">image saved successfully</span></p></body></html>", nullptr));
    } // retranslateUi
