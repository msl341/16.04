...
QT_MOC_LITERAL(3, 22, 14), // "first_key_long"
QT_MOC_LITERAL(4, 37, 10), // "second_key"
QT_MOC_LITERAL(5, 48, 9), // "third_key"
QT_MOC_LITERAL(6, 58, 10), // "fourth_key"
QT_MOC_LITERAL(7, 69, 15), // "fourth_key_long"
QT_MOC_LITERAL(8, 85, 13), // "insertion_key"
QT_MOC_LITERAL(9, 99, 15), // "uninsertion_key"
QT_MOC_LITERAL(10, 115, 13) // "mythread_work"

    },
    "key_thread\0first_key\0\0first_key_long\0"
    "second_key\0third_key\0fourth_key\0"
    "fourth_key_long\0insertion_key\0"
...
void key_thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->first_key_long(); break;
        case 2: _t->second_key(); break;
        case 3: _t->third_key(); break;
        case 4: _t->fourth_key(); break;
        case 5: _t->fourth_key_long(); break;
        case 6: _t->insertion_key(); break;
        case 7: _t->uninsertion_key(); break;
        case 8: _t->mythread_work(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        ...
        {
            using _t = void (key_thread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&key_thread::first_key_long)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void key_thread::first_key_long()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}
