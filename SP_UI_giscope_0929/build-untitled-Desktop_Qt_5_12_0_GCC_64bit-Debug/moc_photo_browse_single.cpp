...
void photo_browse_single::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        photo_browse_single *_t = static_cast<photo_browse_single *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_full_screen *_t = static_cast<Label_full_screen *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_screen *_t = static_cast<Label_screen *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->doubleClicked(); break;
        default: ;
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_delete_ps *_t = static_cast<Label_delete_ps *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_left_ps *_t = static_cast<Label_left_ps *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked_1(); break;
        default: ;
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_right_ps *_t = static_cast<Label_right_ps *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked_1(); break;
        default: ;
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_return_ps *_t = static_cast<Label_return_ps *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked_1(); break;
        default: ;
