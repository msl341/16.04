...
void language_setting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        language_setting *_t = static_cast<language_setting *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_chinese *_t = static_cast<Label_chinese *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_Tchinese *_t = static_cast<Label_Tchinese *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked_1(); break;
        default: ;
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_english *_t = static_cast<Label_english *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked_1(); break;
        default: ;
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_save_L *_t = static_cast<Label_save_L *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked_1(); break;
        default: ;
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_return_L *_t = static_cast<Label_return_L *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked_1(); break;
        default: ;
