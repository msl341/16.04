...
void version_number::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        version_number *_t = static_cast<version_number *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_version_return *_t = static_cast<Label_version_return *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Label_version_update *_t = static_cast<Label_version_update *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked_1(); break;
        default: ;
