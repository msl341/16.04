...
void usb_mcu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        usb_mcu *_t = static_cast<usb_mcu *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        rev_usb_mcu *_t = static_cast<rev_usb_mcu *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        key_thread *_t = static_cast<key_thread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        key_thread_mipi0 *_t = static_cast<key_thread_mipi0 *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->first_key(); break;
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        key_thread_mipi3 *_t = static_cast<key_thread_mipi3 *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        key_thread_290 *_t = static_cast<key_thread_290 *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        shortcut_key *_t = static_cast<shortcut_key *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->key_photo(); break;
        case 1: _t->key_video(); break;
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        movablePushbutton *_t = static_cast<movablePushbutton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
