...
QT_MOC_LITERAL(1, 9, 12), // "showStackTwo"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 12), // "hideKeyBoard"
QT_MOC_LITERAL(4, 36, 8), // "clickPos"
QT_MOC_LITERAL(5, 45, 3), // "pos"
QT_MOC_LITERAL(6, 49, 17), // "setMoveBtnVisible"
QT_MOC_LITERAL(7, 67, 6) // "status"

    },
    "KeyBoard\0showStackTwo\0\0hideKeyBoard\0"
    "clickPos\0pos\0setMoveBtnVisible\0status"
};
...
void KeyBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showStackTwo(); break;
        case 1: _t->hideKeyBoard(); break;
        case 2: _t->clickPos((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 3: _t->setMoveBtnVisible((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KeyBoard::showStackTwo)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (KeyBoard::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KeyBoard::hideKeyBoard)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (KeyBoard::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KeyBoard::clickPos)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void KeyBoard::clickPos(QPoint _t1)
{
