...
#define TIME_NOSELECTED "background-color: transparent;color: rgb(255, 255, 255);border-image: url(:/tu/ALL-IN-ONE ICON/BKG_long_small.png);"
#define TIME_SELECTED "background-color: transparent;color: rgb(62, 193, 255);border-image: url(:/tu/ALL-IN-ONE ICON/BKG_long_small.png);"
...
class DraggableGraphicsView : public QGraphicsView {
    Q_OBJECT
public:
    explicit DraggableGraphicsView(QWidget *parent = nullptr);
...
private:
    ...
    FILE *GpioFile;
    char ChargeGpioVal;
    bool ChargeMode = false, isWarning = false;
};
...
class movablePushbutton : public QPushButton
{
    Q_OBJECT

public:
    movablePushbutton(QWidget *parent = nullptr) : QPushButton(parent) {
    }
...
extern void simulateClick(QWidget* widget, const QPoint& localPos);
