...
public:
    ...
    void setFolderPath(QString patient_id, QString obj_id);
    void switchDatabase();
    void verifyDatabasePath();
...
private:
    ...
    addReport *addReport_widget;
    BrowseReport *browseReport_widget;
    FullReport *fullReport_widget;
    PickPhoto *pickPW;
    KeyBoard *keyboard_widget;
    ErrorFormat *errorFormat_widget;
    ReportSaved *reportSaved_widget;
    ...
    bool databaseConnectError = false;

    std::string FolderPath = "default";
};
#endif // WIDGET_H
