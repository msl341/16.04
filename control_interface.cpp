    ...
    ui(new Ui::control_interface)
{
    ...
    ui->label_use_num->setStyleSheet("font-size: 20px;color: white;");
    ui->label_versions->setStyleSheet("font-size: 15px;");
    ui->label_versions_num->setStyleSheet("font-size: 15px;qproperty-alignment: AlignLeft;color: white;");

    ui->label_1->setStyleSheet("font-size: 15px;color: white;");
    ui->label_2->setStyleSheet("font-size: 15px;color: white;");
    ui->label_3->setStyleSheet("font-size: 15px;color: white;");

    ui->label_zoomnum->setStyleSheet("font-size: 20px;color: white;");
    ...
    connect(ui->label_frames,&Label_frames::clicked_double,this,[=](){
        ...
        ui->label_b->setStyleSheet("background-image: url(:/tu/Display/Small background(X).png);");
    });
    ...
    connect(ui->label_switch,&Label_switch::clicked_1,this,[=](){
        if(video_flag==0 && aspect_ratio_flag==1 && display_flag!=2 && freeze_flag==0)
        {
            ...
            {
                ui->label_switch->setStyleSheet("border-image: url(:/tu/on.png);");
                label_switch_flag=0;
                showAllControlsExcept();
            }
            else if(label_switch_flag==0)
            {
                ui->label_switch->setStyleSheet("border-image: url(:/tu/off.png);");
                label_switch_flag=1;
...
void control_interface::update_duration()
{
    ...
    ui->label_use_num->setText(QString::number(iRemainTime/300));
...
void control_interface::updateTime_date()
{
    ...
    ui->label_years ->setStyleSheet("font-size: 34px;color: white;");
    ui->label_month_day ->setStyleSheet("font-size: 32px;color: white;");
    ui->label_times ->setStyleSheet("font-size: 17px;color: white;");
}

void control_interface::settext()
{
    //ui->label_status->setText(tr("状态信息"));
    //ui->label_status->setStyleSheet("color: white");

    ui->labelw_awb->setText(tr("白平衡:"));
    ui->labelw_awb->setStyleSheet("color: white");

    ui->label_mtoa->setText(tr("自动 "));
  //ui->label_mtoa->setStyleSheet("color: white");

    ui->label_atom->setText(tr("手动"));

    ui->labelw_zoom->setText(tr("缩放倍数:"));
    ui->labelw_zoom->setStyleSheet("color: white");

    ui->labelw_picture->setText(tr("画面模式:"));
    ui->labelw_picture->setStyleSheet("color: white");

    ui->label_picture_1->setText(tr("初始"));
   // ui->label_picture_1->setStyleSheet("color: white");

    ui->label_picture_2->setText(tr("圆形"));
    //ui->label_picture_2->setStyleSheet("color: white");

    ui->label_picture_3->setText(tr("八角形"));
   // ui->label_picture_3->setStyleSheet("color: white");

    ui->label_picture_4->setText(tr("椭圆"));
    //ui->label_picture_4->setStyleSheet("color: white");

    ui->label_picture_5->setText(tr("矩形"));
    //ui->label_picture_5->setStyleSheet("color: white");

    ui->labelw_show->setText(tr("显示模式:"));
    ui->labelw_show->setStyleSheet("color: white");

    ui->label_display_1->setText(tr("单画面模式"));
   // ui->label_display_1->setStyleSheet("color: white");

    ui->label_display_2->setText(tr("双画面模式"));
   // ui->label_display_2->setStyleSheet("color: white");

    ui->label_display_3->setText(tr("子母模式"));
   // ui->label_display_3->setStyleSheet("color: white");

    ui->labelw_language->setText(tr("语言:"));
    ui->labelw_language->setStyleSheet("color: white");

    ui->label_language_c->setText(tr("简体中文"));
    //ui->label_language_c->setStyleSheet("color: white");

    ui->label_language_ct->setText(tr("繁体中文"));
    //ui->label_language_ct->setStyleSheet("color: white");

    ui->label_language_e->setText(tr("英文"));
    //ui->label_language_e->setStyleSheet("color: white");

    ui->label_store->setText(tr("储存"));
    ui->label_store->setStyleSheet("color: white");

    ui->labelw_number->setText(tr("使用次数:"));
    ui->labelw_number->setStyleSheet("color: white");

    ui->labelw_time->setText(tr("使用时长:"));
    ui->labelw_time->setStyleSheet("color: white");

    ui->label_versions->setText(tr("当前版本:"));
    ui->label_versions->setStyleSheet("color: white");
    ui->label_language_x->setText(tr("西班牙"));
    //ui->label_language_x->setStyleSheet("color: white");
}
