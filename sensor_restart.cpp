    ...
    ui(new Ui::sensor_restart)
{
    ...
    ui->label_ok->setStyleSheet("border-radius: 10px 10px 10px 10px;background-color: rgb(151, 235, 238);font-size: 24px;color: white");
...
void sensor_restart::settext()
{
    ...
    ui->label_num1->setStyleSheet("font-size: 24px;color: white");
    ui->label_num2->setStyleSheet("font-size: 24px;color: white");
