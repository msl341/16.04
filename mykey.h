...
#define FIRST_KEY                   stCfg.adc_value > 300 && stCfg.adc_value <= 380
#define SECOND_KEY                  stCfg.adc_value > 680 && stCfg.adc_value <= 750
#define THIRD_KEY                   stCfg.adc_value > 770 && stCfg.adc_value <= 850
#define FOURTH_KEY                  stCfg.adc_value > 600 && stCfg.adc_value <= 655//有长按
//#define INSERTION_KEY               stCfg.adc_value > 780 && stCfg.adc_value <= 820
//#define INSERTION_KEY               stCfg.adc_value > 800 && stCfg.adc_value <= 845
#define INSERTION_9734KEY           stCfg.adc_value > 800 && stCfg.adc_value <= 860
#define INSERTION_02c10KEY          stCfg.adc_value > 900 && stCfg.adc_value <= 960
#define INSERTION_2740KEY           stCfg.adc_value > 600 && stCfg.adc_value <= 660
...
private:
 ...
 //通道2 按键检测线程（独立于通道1的MIPI插拔检测）
class key_thread_channel2 : public QObject
{
    Q_OBJECT
public:
    explicit key_thread_channel2(QObject *parent = nullptr);
